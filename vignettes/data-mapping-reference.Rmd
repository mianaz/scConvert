---
title: "Format Mapping Reference"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Format Mapping Reference}
...
**Notes:** Scale data is not stored in h5ad (recompute with `ScaleData()` or
`sc.pp.scale()`). Data (all genes) is written to `X`; scale.data (variable
features only) is skipped.
...
(`H5ADToZarr()`, `ZarrToH5AD()`, etc.) transfer data without constructing
a Seurat object in memory.
