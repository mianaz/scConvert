...
if (has_SeuratData) {
  ...
  has_multiome <- file.exists("multiome_demo.h5mu")
}
has_muon <- FALSE
has_scanpy <- FALSE
...
- [Multimodal: h5mu Format](multimodal-h5mu.html) -- native h5mu read/write without external dependencies
- [scATAC-seq with Signac](scatac-signac.html) -- converting chromatin accessibility data
