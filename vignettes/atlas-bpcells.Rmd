...
matrix. For 329K cells × 28K genes, this requires **~4--6 GB** of RAM.
...
embeddings, and graphs are loaded into RAM — typically **under 500 MB** even
...
To verify BPCells mode works on your system, here is a small-scale example
using the shipped demo data.
