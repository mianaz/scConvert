...
```{r hfile, echo=FALSE, purl = FALSE}
hfile <- H5File$new(filename = tempfile(fileext = ".h5"), mode = "a")
```

```{r link_functions, echo=FALSE, purl = FALSE}
...
```{r densemat, echo=FALSE, purl = FALSE}
...
```{r sparsemat, echo=FALSE, purl = FALSE}
...
```{r sparsemat_indptr, echo=FALSE, purl = FALSE}
...
```{r sparsemat_dims, echo=FALSE, purl = FALSE}
...
```{r factor, echo=FALSE, purl = FALSE}
...
```{r factor_levels, echo=FALSE, purl = FALSE}
...
```{r factor_values, echo=FALSE, purl = FALSE}
...
```{r logicals, echo=FALSE, purl = FALSE}
...
```{r df_options, echo=FALSE, purl = FALSE}
op <- options(scConvert.dtypes.dataframe_as_group = FALSE)
```

```{r dfdataset, echo=FALSE, purl = FALSE}
df <- data.frame(
  x = c("g1", "g1", "g2", "g1", "g2"),
  y = 1:5,
...
```{r df_restore, echo=FALSE, purl = FALSE}
options(op)
```
...
```{r dfgroup, echo=FALSE, purl = FALSE}
df$x <- factor(x = df$x)
