...
To save a Seurat object as a Loom file, use `scSaveLoom()`:
...
Use `scLoadLoom()` to read a Loom file as a Seurat object:
...
`scLoadLoom()` provides several options for customizing the import:
