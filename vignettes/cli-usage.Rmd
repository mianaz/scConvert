...
```{r basic_usage, eval = FALSE, purl = FALSE}
library(scConvert)
...
```{r bpcells, eval = FALSE, purl = FALSE}
...
- [Converting Between Seurat and Zarr](convert-zarr.html) -- direct Zarr streaming converters and round-trip examples
