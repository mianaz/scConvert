...
writing back to h5ad (`SeuratToH5AD`). The table below shows performance on
...
For datasets exceeding available memory, `LoadH5AD()` supports
...
df <- data.frame(
  ...
  method = rep(c("h5ad → Seurat (LoadH5AD)",
                 "Seurat → h5ad (SeuratToH5AD)",
