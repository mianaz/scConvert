...
A standalone C binary for HDF5-based conversions (h5ad, h5Seurat, h5mu, Loom)
without R or Python:
...
- [Zarr Format](https://mianaz.github.io/scConvert/articles/convert-zarr.html)
- [Spatial Technologies](https://mianaz.github.io/scConvert/articles/spatial-technologies.html)
