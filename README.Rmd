...
# `r pkg` <img src="man/figures/graphical_abstract.png" align="right" width="45%" />

<!-- badges: start -->
[![CRAN status](https://www.r-pkg.org/badges/version/`r pkg`)](https://CRAN.R-project.org/package=`r pkg`)
...
Direct HDF5 paths bypass the hub for h5ad/h5Seurat conversions.
...
This hub design achieves **O(n) implementation complexity** for n formats
instead of O(n^2) pairwise converters.
...
- [Direct H5AD Loading](https://mianaz.github.io/scConvert/articles/direct-h5ad-loading.html)
