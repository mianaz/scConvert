...
#> SpatialData store written to: /tmp/Rtmp6p9VJg/brain.spatialdata.zarr
```
...
#>  [37] ica_1.0-3              spatstat.data_3.1-9    bslib_0.11.0          
#>  [40] stringi_1.8.7          RColorBrewer_1.1-3     reticulate_1.46.0     
#>  [43] spatstat.univar_3.2-0  parallelly_1.47.0      lmtest_0.9-40         
