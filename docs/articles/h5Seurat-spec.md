...
in “data”
    ...
    #> [2,] . 1 1 1
    #> [3,] 1 1 . .
    #> HDF5 Group: sparsemat
    #>   Members: data, indices, indptr
    #> 
    #> HDF5 Dataset: sparsemat/indices
    #>   Length: 6
    #> [1] 2 1 2 1 0 1
    #> 
    #> HDF5 Dataset: sparsemat/data
    #>   Length: 6
    #> [1] 1 1 1 1 1 1
...
correspond to the data frame column names.
    ...
    #> 4 g1 4
    #> 5 g2 5
    #> HDF5 Dataset: dfdataset (compound)
    #>   Length: 5
    #>    x y
    #> 1 g1 1
    #> 2 g1 2
