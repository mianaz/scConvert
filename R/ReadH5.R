...
#' @param recursive Whether to recursively convert subgroups to nested lists
#'
#' @rdname ReadH5
...
#' @param transpose scTranspose the matrix before returning
#'
...
#' @param name_map_fn Optional function to map column names
#'
#' @keywords internal
#'
