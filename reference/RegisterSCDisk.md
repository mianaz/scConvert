# Get and Register [`scdisk`](https://mianaz.github.io/scConvert/reference/scdisk-class.md) Subclasses
...
`scdisk` subclasses; otherwise, a
[generator](https://r6.r-lib.org/reference/R6Class.html) for the
requested `scdisk` subclass
...
#>     v3.2.0: function () 
#>     v5.0.0: function () 
#>   Parent env: <environment: namespace:scConvert>
#>   Locked objects: TRUE
#>   Locked class: TRUE
#>   Portable: TRUE
