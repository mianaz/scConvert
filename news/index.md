...
> **Status:** unreleased; rolling development between 0.1.0 and the next
> tag.
...
- Added `tests/testthat/test-regression-fixes.R` with three regression
  tests pinning the bugs listed above. The test suite is now **140
  `test_that` blocks** with **465 assertions** (up from 137 / 448).
